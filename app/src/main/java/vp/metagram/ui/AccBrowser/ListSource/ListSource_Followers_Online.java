...
public class ListSource_Followers_Online extends ListSource
{
    long IPK = -1;
    String nextHash = "";
    ...
    public ListSource_Followers_Online(long IPK, Map<Long,User> sourceList, InstagramAgent agent)
    {
        super(sourceList);
        this.IPK = IPK;
        this.agent = agent;
    ...
    public ListSource_Followers_Online(long IPK, Map<Long,User> sourceList)
    {
        super(sourceList);
        this.IPK = IPK;
    ...
    public Map<Long,User> getNextList() throws IOException, NoSuchAlgorithmException, JSONException, IGWAException
    {
        ...
        else if (nextHash != null)
        {
            ...
            nextHash = agent.proxy.getFollowerList(IPK, followersList, nextHash);
            sourceList.putAll(followersList);
        }
