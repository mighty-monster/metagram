...
public class SomeonesCommentsSource extends ReportListSource
{
    ...
    String QueryFromPart = "Select Distinct MPK, MiniLink, MID, PostType, URLs, Caption, Posts.PicURL, Others.Username, Others.PictureURL, Others.IPK, CommentText from Rel_Comment LEFT JOIN Posts\n" +
