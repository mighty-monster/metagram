...
public class FollowingBackSource extends ReportListSource
{
    long FIPK = -1;
    ...
    String QueryFromPart = " from Rel_Following Left Join Others\n" +
            ...
            "    Where Rel_Following.StatJobID = %d and Rel_Following.FIPK = %d  and FollowingIPK in \n" +
            "          (\n" +
    ...
    public FollowingBackSource(long FIPK, List<ReportUser> sourceList, String searchValue)
    {
        super(sourceList);
        this.FIPK = FIPK;
