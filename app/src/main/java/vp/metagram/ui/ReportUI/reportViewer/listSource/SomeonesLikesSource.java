...
public class SomeonesLikesSource extends ReportListSource
{
    long FIPK = -1;
    int lastID = -1;
    long IPK = -1;
    ...
    public SomeonesLikesSource(long FIPK, List<ReportPostUser> sourceList, String searchValue, long IPK)
    {
        super(sourceList);
        this.FIPK = FIPK;
    ...
    public List<ReportPostUser> getNextList() throws Exception
    {
        ...
        else
        {
            ...
            String sqlText = String.format(Locale.ENGLISH," Select * from ( " + QueryFromPart + " )",FIPK,lastID,IPK,searchValue);
