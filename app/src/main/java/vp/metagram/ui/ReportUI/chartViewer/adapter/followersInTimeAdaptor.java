...
public class followersInTimeAdaptor extends ChartAdaptor
{
    long IPK;
    List<Pair<Long,Pair<Long,Long>>> results = new ArrayList<>();

    public followersInTimeAdaptor(Context context, ChartType chartType, QueryStepType stepType, long IPK) throws Exception
    {
    ...
    public void fillResult() throws Exception
    {
        ...
        {
            long index = 0;
            String objectName = "noOfFollowers";
