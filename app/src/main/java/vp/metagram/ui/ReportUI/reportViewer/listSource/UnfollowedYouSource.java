...
public class UnfollowedYouSource extends ReportListSource
{
    long FIPK = -1;
    String searchValue;
    int lastID = -1;
    ...
    String QueryFromPart = " from Rel_Follower Left Join Others\n" +
                            "    On FollowerIPK = Others.IPK\n" +
                            " Where Rel_Follower.StatJobID < %d and Rel_Follower.FIPK = %d  and Username like '%%%s%%'";
    ...
    public UnfollowedYouSource(long FIPK, List<ReportUser> sourceList, String searchValue)
    {
        super(sourceList);
        this.FIPK = FIPK;
