...
public class LikedWithoutFollowSource extends ReportListSource
{
    long FIPK = -1;
    String searchValue;
    ...
    public LikedWithoutFollowSource(long FIPK, List<ReportPostUser> sourceList, String searchValue)
    {
        super(sourceList);
        this.FIPK = FIPK;
