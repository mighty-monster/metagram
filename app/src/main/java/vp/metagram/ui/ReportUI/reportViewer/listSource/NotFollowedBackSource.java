...
public class NotFollowedBackSource extends ReportListSource
{
    long FIPK = -1;
    String searchValue;
    ...
    String QueryFromPart =  " from Rel_Follower Left Join Others\n" +
                            ...
                            "    Where Rel_Follower.StatJobID = %d and Rel_Follower.FIPK = %d  and FollowerIPK not in \n" +
                            "          (\n" +
                            "          Select FollowingIPK from Rel_Following \n" +
                            "            Where Rel_Following.StatJobID = %d and Rel_Follower.FIPK = %d  \n" +
                            "          ) \n" +
                            "    and Username like '%%%s%%'";
    ...
    public NotFollowedBackSource(long FIPK, List<ReportUser> sourceList, String searchValue)
    {
        super(sourceList);
        this.FIPK = FIPK;
