package vp.tools.datetime;

/**
 * Created by arash on 2/4/18.
 */
...
public class JalaliCalendar extends Calendar
{
    ...
    public static class YearMonthDate
    {
        ...
        public String toStringRevert()
        {
            String result = "";

            if (getDate() < 10)
            {
                result += String.format("%d%d",0,getDate());
            }
            else
            {
                result += String.format("%d",getDate());
            }
            ...
            if (month < 10)
            {
                result += String.format("%d%d",0,month);
            }
            else
            {
            ...
            if (getYear() < 10)
            {
                result += String.format("%d%d",0,getYear());
            }
            else
            {
                result += String.format("%d",getYear());
            }
