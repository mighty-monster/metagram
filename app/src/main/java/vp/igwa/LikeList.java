...
public class LikeList implements IGWADigest
{
    public Map<Long, User> likers = new LinkedHashMap<>(10,(float)0.75, true);
    public String next_hash;
    public int count;

    @Override
    public LikeList digest(JSONObject jsonObject) throws JSONException
    {
        jsonObject = jsonObject.getJSONObject("data");
        jsonObject = jsonObject.getJSONObject("shortcode_media");
        jsonObject = jsonObject.getJSONObject("edge_liked_by");
        ...
        for (int i=0; i < edges.length(); i++)
        {
            ...
            likers.put(newUser.IPK, newUser);
        }
